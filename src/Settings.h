...
public:
    ...
    BG_SOURCE bg_source;
    BG_SOURCE bg_source_secondary;
    String dexcom_username;
    String dexcom_password;
    DEXCOM_SERVER dexcom_server;
    String dexcom_username_secondary;
    String dexcom_password_secondary;
    DEXCOM_SERVER dexcom_server_secondary;
    String librelinkup_email;
    String librelinkup_password;
    String librelinkup_region;
    String librelinkup_patient_id;
    String librelinkup_email_secondary;
    String librelinkup_password_secondary;
    String librelinkup_region_secondary;
    String librelinkup_patient_id_secondary;
    // Medtrum Easy Follow
    String medtrum_email;
    String medtrum_password;
    String medtrum_email_secondary;
    String medtrum_password_secondary;
    String nightscout_url_secondary;
    String nightscout_api_key_secondary;
    bool nightscout_simplified_api_secondary;
